...
from ORC_plot import ProcessPlot, set_windows, plot_SaturationofCurve, plot_StatusofORC, test_plot_StatusofORC
...
if __name__=='__main__':
    ...
    Data = Paser_data('.~lock.Data 8199 2391 2_12_2018 14_23_36.csv#')
    Data.parser_csv()
    header = Data.header
    data = Data.read_csv()
